...
#' @keywords datasets
#' @name dvsMonthly.csv
#' @usage readr::read_csv("vignettes/dvsMonthly.csv")
...
#' @docType data
#' @keywords datasets
#' @name testFlowDat.csv
#' @usage readr::read_csv("extdata/testFlowDat.csv")
#' @format A CSV file containing 158526 observations of 39 variables
NULL

#' Shapefile containing drainage areas for gaged and ungaged sites
#'
#' @docType data
#' @keywords datasets
#' @name sitesAll.shp
#' @usage raster::shapefile("extdata/sitesAll.shp")
#' @format A shapefile of drainage basins for all gaged and ungaged sites included in the random forest model

#' @examples
#' myBasinFile <- system.file("extdata", "sitesAll.shp", package = "mapRandomForest")
#'
