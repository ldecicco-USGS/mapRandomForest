...
library(magrittr)
rf_model_inputs_filename <- system.file("data","random_forest_model_stream_and_temp_inputs.rds", package = "mapRandomForest")

df <- readr::read_rds(rf_model_inputs_filename)
...
readr::write_rds(df,"random_forest_model_stream_temp_ET0_inputs.rds", compress="gz")
```
