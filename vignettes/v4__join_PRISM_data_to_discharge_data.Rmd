...
mean_ppt_values <- readr::read_csv("mean_ppt_values_w_lag.csv.gz")
mean_ppt_values$yyyymmdd <- lubridate::ymd(paste(mean_ppt_values$date,"01",sep="-"))
...
mean_ppt_values <- dplyr::select(mean_ppt_values,joinfield,precip,precip_lag_1m,precip_lag_2m,precip_sum_6m,group_id)
...
mean_tmin_values <- readr::read_csv("mean_tmin_values_w_lag.csv.gz")
...
mean_tmax_values <- readr::read_csv("mean_tmax_values_w_lag.csv.gz")
...
mean_tmean_values <- readr::read_csv("mean_tmean_values_w_lag.csv.gz")
...
centroid_coordinates_df <- readr::read_csv("centroid_coordinates.csv.gz")
...
readr::write_csv(random_forest_training_df,"random_forest_model_stream_and_temp_inputs.csv.gz")
