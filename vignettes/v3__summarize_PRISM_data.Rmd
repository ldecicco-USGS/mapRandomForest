...
flow_data <- readr::read_csv('monthly_discharge.csv.gz')
...
readr::write_csv(mean_ppt_values,"mean_ppt_values.csv.gz")
```
...
readr::write_csv(mean_tmin_values,"mean_tmin_values.csv.gz")
```
...
readr::write_csv(mean_tmax_values,"mean_tmax_values.csv.gz")
```
...
readr::write_csv(mean_tmean_values,"mean_tmean_values.csv.gz")
```
...
mean_tmin_values <- readr::read_csv("mean_tmin_values.csv.gz") %>%
                           dplyr::group_by(site_no) %>%
                           dplyr::mutate(block_id=identify_contiguous(date)) %>%
                           dplyr::mutate(group_id=paste(site_no,block_id,sep="_"))

mean_tmax_values <- readr::read_csv("mean_tmax_values.csv.gz") %>%
                           dplyr::group_by(site_no) %>%
                           dplyr::mutate(block_id=identify_contiguous(date)) %>%
                           dplyr::mutate(group_id=paste(site_no,block_id,sep="_"))

mean_tmean_values <- readr::read_csv("mean_tmean_values.csv.gz") %>%
                           dplyr::group_by(site_no) %>%
                           dplyr::mutate(block_id=identify_contiguous(date)) %>%
                           dplyr::mutate(group_id=paste(site_no,block_id,sep="_"))

mean_ppt_values <- readr::read_csv("mean_ppt_values.csv.gz") %>% 
                     dplyr::group_by(site_no) %>%
                     dplyr::mutate(block_id=identify_contiguous(date)) %>%
                     dplyr::mutate(group_id=paste(site_no,block_id,sep="_"))
```
...
readr::write_csv(mean_ppt_values_lagged, "mean_ppt_values_w_lag.csv.gz")
```
...
readr::write_csv(mean_tmin_values_lagged, "mean_tmin_values_w_lag.csv.gz")
```
...
readr::write_csv(mean_tmax_values_lagged, "mean_tmax_values_w_lag.csv.gz")
```
...
readr::write_csv(mean_tmean_values_lagged, "mean_tmean_values_w_lag.csv.gz")
```
